...
struct ProjectMutationTests {
    ...
    @Test func nodeDeletionCleansUpConnections() throws {
        let node1 = SpatialNode(id: UUID(), type: .standard, position: .zero, title: "N1")
        let node2Id = UUID()
        let node2 = SpatialNode(id: node2Id, type: .standard, position: .zero, title: "N2")
        
        var node3 = SpatialNode(id: UUID(), type: .standard, position: .zero, title: "N3")
    ...
    @Test func undoingNodeDeletionRestoresCleanedConnections() throws {
        ...
        var sourceNode = SpatialNode(id: sourceId, type: .standard, position: .zero, title: "Source")
        sourceNode.nextNodeId = targetId
        sourceNode.connectedNodeIds = [targetId]

        let targetNode = SpatialNode(id: targetId, type: .standard, position: .zero, title: "Target")
    ...
    @Test func organizeNodesRegistersUndoAndRedo() throws {
        let node1Id = UUID()
        let node2Id = UUID()
        let node1 = SpatialNode(id: node1Id, type: .standard, position: CGPoint(x: 10, y: 20), title: "Node 1")
        let node2 = SpatialNode(id: node2Id, type: .standard, position: CGPoint(x: 30, y: 40), title: "Node 2")
    ...
    @Test func organizeNodesProducesHierarchicalFlow() throws {
        let node1Id = UUID()
        let node2Id = UUID()
        var node1 = SpatialNode(id: node1Id, type: .standard, position: CGPoint(x: 100, y: 100), title: "Source")
        let node2 = SpatialNode(id: node2Id, type: .standard, position: CGPoint(x: 0, y: 0), title: "Target")
    ...
    @Test func organizeNodesUsesUniformVerticalSpacingForCards() throws {
        let sourceId = UUID()
        let node1Id = UUID()
        let node2Id = UUID()
        
        let source = SpatialNode(id: sourceId, type: .standard, position: CGPoint(x: -100, y: 0), title: "Source")
        let node1 = SpatialNode(id: node1Id, type: .standard, position: CGPoint(x: 0, y: 0), title: "Card 1")
        let node2 = SpatialNode(id: node2Id, type: .standard, position: CGPoint(x: 100, y: 100), title: "Card 2")
        ...
        #expect(distanceY == 220)
    }

    @Test func organizeNodesAvoidsClusterOverlap() throws {
        let node1 = SpatialNode(id: UUID(), type: .standard, position: CGPoint(x: 0, y: 0), title: "Cluster 1 Node")
        let node2 = SpatialNode(id: UUID(), type: .standard, position: CGPoint(x: 100, y: 100), title: "Cluster 2 Node")
