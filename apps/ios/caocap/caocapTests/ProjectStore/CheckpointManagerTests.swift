...
final class CheckpointManagerTests: XCTestCase {
    ...
    func testRestoreCheckpoint() async throws {
        let snapshot = ProjectSnapshot(schemaVersion: ProjectPersistenceService.currentSchemaVersion, projectName: "Test", nodes: [SpatialNode(type: .standard, position: .zero, title: "Card")], viewportOffset: .zero, viewportScale: 1.0)
