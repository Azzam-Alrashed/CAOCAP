...
IDK what I'm doing. This project is my passion project, and working on it is my unique way of having fun!
...
The old goal was to make it super easy, simple, cheap & fun (E.S.C.F) to turn any **idea into software**.
...
The next pivot is documented in [Azzamification of CAOCAP](docs/AZZAMIFICATION_OF_CAOCAP.md).
