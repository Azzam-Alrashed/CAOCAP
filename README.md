...
CAOCAP is bigger than the current implementation. the current implementation is not the doctrine. It's just an experiment in service of the larger act: challenging the inherited shape of software development and building better ways to ( ideas -> software ).
